...
def _build_engine_onnx(input_onnx: Union[str, bytes], force_fp16: bool = False, max_batch_size: int = 1,
    ...
    :param input_onnx: serialized ONNX weights.
...
def convert_onnx(input_onnx: Union[str, bytes], engine_file_path: str, force_fp16: bool = False,
    ...
    :param input_onnx: Path to ONNX file on disk or serialized ONNX weights.
...
if __name__ == "__main__":
    onnx_model = "./weights/model_r100.onnx"
    convert_onnx(input_onnx=onnx_model, engine_file_path="../weights/model_r100.engine")
